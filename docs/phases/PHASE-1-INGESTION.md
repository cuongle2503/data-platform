...
- [x] Create `src/idp/common/http_client.py`:
...
- [x] Create `src/idp/common/minio_client.py`:
...
- [x] Update `src/idp/common/config.py`:
...
- [x] Create `src/idp/ingestion/world_bank/indicators.py`:
...
- [x] Create `src/idp/ingestion/world_bank/bronze_schema.py`:
...
- [x] Create `src/idp/ingestion/world_bank/pipeline.py`:
...
- [x] Create `src/idp/ingestion/world_bank/docs_metadata.py`:
...
- [x] Create `src/idp/ingestion/world_bank/docs_text.py`:
...
- [x] Create `src/idp/ingestion/cli.py`:
...
- [x] Check coverage: ensure >80% for `src/idp/ingestion/`
